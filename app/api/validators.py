...
def check_charity_project_with_invested_sum(project: CharityProject, new_amount: int):
...
def check_charity_project_was_invested(charity_project: CharityProject):
